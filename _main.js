...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initOperation)\n/* harmony export */ });\nfunction initOperation() {\n  var element = document.querySelector('[data-week');\n  var now = new Date();\n  var weeks = element.dataset.week.split(',').map(Number);\n  var hours = element.dataset.hours.split(',').map(Number);\n  var openWeek = weeks.indexOf(now.getDay()) !== -1;\n  var openHour = now.getHours() >= hours[0] && now.getHours() < hours[1];\n\n  if (openWeek && openHour) {\n    element.classList.add('active');\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/operation.js?");
